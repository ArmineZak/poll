...
CREATE TABLE  result(
                        ...
                        CONSTRAINT fk_poll_id1 FOREIGN KEY (poll_id) REFERENCES poll (poll_id) on delete cascade
);
...
INSERT INTO poll(NAME, DESCRIPTION) VALUES ( 'Шкала депресии Аарона Бека', 'Методика Шкала депрессии Бека.');
...
INSERT INTO result(explanation, min_score, max_score, poll_id) VALUES ( 'Отсутствие депрессивных симптомов', '0', '9', '1');
INSERT INTO result(explanation, min_score, max_score, poll_id) VALUES ( 'Легкая депрессия (субдепрессия)', '10', '15', '1');
INSERT INTO result(explanation, min_score, max_score, poll_id) VALUES ( 'Умеренная депрессия', '16', '19', '1');
INSERT INTO result(explanation, min_score, max_score, poll_id) VALUES ( 'Выраженная депрессия (средней тяжести)', '20', '29', '1');
INSERT INTO result(explanation, min_score, max_score, poll_id) VALUES ( 'Тяжёлая депрессия', '30', '63', '1');
